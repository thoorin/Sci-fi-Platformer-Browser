...
M.createLevel7 = function()
    ...
    do
        ...
        c.createBlockTop(2050,top)
        c.createBlockStartTop(2030,top)
        c.createBlockEndTop(2082,top)
...
M.createLevel9 = function()
    ...
    do
        ...
        M.createSetOfBlocks(start,top,28)
        --c.createFrog(start + 50, top)
        c.createFrog(start + 400, top)
...
M.createLevel10 = function()
    ...
    do 
        ...
        c.createFrog(start + 630, top-128)
        c.createFrog(start + 690, top-128)
